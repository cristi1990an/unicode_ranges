...
consteval bool slice_members_preserve_receiver_ownership()
{
	...
	using throwing_predicate_type = throwing_char_predicate<Char>;
		...
		&& std::same_as<decltype(std::declval<View>().substr_unchecked(std::size_t{}, std::size_t{})), View>
		...
		&& std::same_as<decltype(std::declval<const Owned&>().substr_unchecked(std::size_t{})), Owned>
		&& std::same_as<decltype(std::declval<Owned>().substr(std::size_t{}, std::size_t{})), opt_owned>
		&& std::same_as<decltype(std::declval<Owned>().substr_unchecked(std::size_t{}, std::size_t{})), Owned>
		...
		&& noexcept(std::declval<View>().substr_unchecked(std::size_t{}))
		&& !noexcept(std::declval<const Owned&>().substr_unchecked(std::size_t{}))
		&& noexcept(std::declval<Owned>().substr(std::size_t{}))
		&& noexcept(std::declval<Owned>().substr_unchecked(std::size_t{}))
...
UTF8_RANGES_TEST_OPTNONE UTF8_RANGES_TEST_NOINLINE inline void run_unicode_ranges_tests()
{
	...
	using utf8_owned_matches_set_view = decltype(utf8_string{}.matches(std::array{ u8" "_u8c }));
	using utf8_owned_match_indices_view = decltype(utf8_string{}.match_indices(u8" "_utf8_sv));
	using utf8_owned_match_indices_set_view = decltype(utf8_string{}.match_indices(std::array{ u8" "_u8c }));
	using utf8_owned_rmatches_view = decltype(utf8_string{}.rmatches(u8" "_utf8_sv));
	using utf8_owned_rmatches_set_view = decltype(utf8_string{}.rmatches(std::array{ u8" "_u8c }));
	using utf8_owned_rmatch_indices_view = decltype(utf8_string{}.rmatch_indices(u8" "_u8c));
	using utf8_owned_rmatch_indices_set_view = decltype(utf8_string{}.rmatch_indices(std::array{ u8" "_u8c }));
	...
	using utf16_owned_matches_set_view = decltype(utf16_string{}.matches(std::array{ u" "_u16c }));
	using utf16_owned_match_indices_view = decltype(utf16_string{}.match_indices(u" "_utf16_sv));
	using utf16_owned_match_indices_set_view = decltype(utf16_string{}.match_indices(std::array{ u" "_u16c }));
	using utf16_owned_rmatches_view = decltype(utf16_string{}.rmatches(u" "_utf16_sv));
	using utf16_owned_rmatches_set_view = decltype(utf16_string{}.rmatches(std::array{ u" "_u16c }));
	using utf16_owned_rmatch_indices_view = decltype(utf16_string{}.rmatch_indices(u" "_u16c));
	using utf16_owned_rmatch_indices_set_view = decltype(utf16_string{}.rmatch_indices(std::array{ u" "_u16c }));
	...
	using utf32_owned_matches_set_view = decltype(utf32_string{}.matches(std::array{ U" "_u32c }));
	using utf32_owned_match_indices_view = decltype(utf32_string{}.match_indices(U" "_utf32_sv));
	using utf32_owned_match_indices_set_view = decltype(utf32_string{}.match_indices(std::array{ U" "_u32c }));
	using utf32_owned_rmatches_view = decltype(utf32_string{}.rmatches(U" "_utf32_sv));
	using utf32_owned_rmatches_set_view = decltype(utf32_string{}.rmatches(std::array{ U" "_u32c }));
	using utf32_owned_rmatch_indices_view = decltype(utf32_string{}.rmatch_indices(U" "_u32c));
	using utf32_owned_rmatch_indices_set_view = decltype(utf32_string{}.rmatch_indices(std::array{ U" "_u32c }));
	...
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf8_owned_matches_set_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf8_owned_match_indices_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf8_owned_match_indices_set_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf8_owned_rmatches_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf8_owned_rmatches_set_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf8_owned_rmatch_indices_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf8_owned_rmatch_indices_set_view>);
	...
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf16_owned_matches_set_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf16_owned_match_indices_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf16_owned_match_indices_set_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf16_owned_rmatches_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf16_owned_rmatches_set_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf16_owned_rmatch_indices_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf16_owned_rmatch_indices_set_view>);
	...
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf32_owned_matches_set_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf32_owned_match_indices_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf32_owned_match_indices_set_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf32_owned_rmatches_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf32_owned_rmatches_set_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf32_owned_rmatch_indices_view>);
	static_assert(unicode_ranges_test_details::move_only_non_borrowed_view<utf32_owned_rmatch_indices_set_view>);
	...
	static_assert(std::ranges::view<decltype(utf32_text.match_indices(U"\u00E9"_u32c))>);
	static_assert(std::ranges::range<decltype(utf32_text.match_indices(U"\u00E9"_u32c))>);
	static_assert(std::same_as<
		std::ranges::range_value_t<decltype(utf32_text.match_indices(U"\u00E9"_u32c))>,
		std::pair<std::size_t, utf32_string_view>>);
	static_assert(utf32_text.size() == 3);
	static_assert(std::same_as<decltype(utf32_text.copy(static_cast<char32_t*>(nullptr), std::size_t{})), utf32_string_view::size_type>);
	...
	static_assert([] {
		constexpr auto mixed = U"A\u00E9B"_utf32_sv;
		return std::ranges::equal(mixed.matches(std::array{ U"A"_u32c, U"\u00E9"_u32c }), std::array{
				U"A"_utf32_sv,
				U"\u00E9"_utf32_sv
			})
			&& std::ranges::equal(mixed.match_indices(std::array{ U"A"_u32c, U"\u00E9"_u32c }), std::array{
				std::pair<std::size_t, utf32_string_view>{ 0, U"A"_utf32_sv },
				std::pair<std::size_t, utf32_string_view>{ 1, U"\u00E9"_utf32_sv }
			})
			&& std::ranges::equal(mixed.rmatches(std::array{ U"A"_u32c, U"\u00E9"_u32c }), std::array{
				U"\u00E9"_utf32_sv,
				U"A"_utf32_sv
			})
			&& std::ranges::equal(mixed.rmatch_indices(std::array{ U"A"_u32c, U"\u00E9"_u32c }), std::array{
				std::pair<std::size_t, utf32_string_view>{ 1, U"\u00E9"_utf32_sv },
				std::pair<std::size_t, utf32_string_view>{ 0, U"A"_utf32_sv }
			});
	}());
	static_assert(utf32_text.substr(1, 1).value() == U"\u00E9"_utf32_sv);
	static_assert(!utf32_text.substr(0, 4).has_value());
	static_assert(utf32_text.substr_unchecked(1) == U"\u00E9\U0001F600"_utf32_sv);
	static_assert(utf32_text.substr_unchecked(2, 1) == U"\U0001F600"_utf32_sv);
	static_assert(!U"e\u0301\U0001F1F7\U0001F1F4!"_utf32_sv.grapheme_substr(2, 4).has_value());
	...
	static_assert(std::same_as<
		...
		utf8_string_view>);
	static_assert(std::ranges::view<decltype(utf8_text.match_indices(u8"\u00E9"_u8c))>);
	static_assert(std::ranges::range<decltype(utf8_text.match_indices(u8"\u00E9"_u8c))>);
	static_assert(std::same_as<
		std::ranges::range_value_t<decltype(utf8_text.match_indices(u8"\u00E9"_u8c))>,
	...
	static_assert([] {
		...
		return text.contains(std::span{ any_of })
			...
			&& first.has_value()
			&& first.left() == u8""_utf8_sv
			&& first.right() == u8"A\u20AC"_utf8_sv
			&& last.has_value()
			&& last.left() == u8"\u00E9A"_utf8_sv
			&& last.right() == u8""_utf8_sv;
	}());
	static_assert(std::same_as<
	...
	static_assert(std::same_as<
		...
		split_once_at_result<utf8_string_view>>);
	static_assert(std::same_as<
		decltype(utf8_text.split_once_at_unchecked(1)),
		split_once_at_unchecked_result<utf8_string_view>>);
	static_assert(std::ranges::view<split_once_result<utf8_string_view>>);
	static_assert(std::ranges::view<split_once_at_result<utf8_string_view>>);
	static_assert(std::ranges::view<split_once_at_unchecked_result<utf8_string_view>>);
	static_assert(std::ranges::sized_range<split_once_result<utf8_string_view>>);
	static_assert(std::ranges::sized_range<split_once_at_result<utf8_string_view>>);
	static_assert(std::ranges::sized_range<split_once_at_unchecked_result<utf8_string_view>>);
	static_assert(std::ranges::contiguous_range<split_once_result<utf8_string_view>>);
	static_assert(std::ranges::contiguous_range<split_once_at_result<utf8_string_view>>);
	static_assert(std::ranges::contiguous_range<split_once_at_unchecked_result<utf8_string_view>>);
	static_assert(std::same_as<
		std::ranges::range_reference_t<split_once_result<utf8_string_view>>,
		const utf8_string_view&>);
	static_assert(std::same_as<
		std::ranges::range_reference_t<split_once_at_result<utf8_string_view>>,
		const utf8_string_view&>);
	static_assert(std::same_as<
		std::ranges::range_reference_t<split_once_at_unchecked_result<utf8_string_view>>,
		const utf8_string_view&>);
	...
	static_assert(std::same_as<
		...
		utf16_string_view>);
	static_assert(std::ranges::view<decltype(utf16_text.match_indices(u"\u00E9"_u16c))>);
	static_assert(std::ranges::range<decltype(utf16_text.match_indices(u"\u00E9"_u16c))>);
	static_assert(std::same_as<
		std::ranges::range_value_t<decltype(utf16_text.match_indices(u"\u00E9"_u16c))>,
	...
	static_assert([] {
		...
		return text.contains(std::span{ any_of })
			...
			&& first.has_value()
			&& first.left() == u""_utf16_sv
			&& first.right() == u"A\U0001F600"_utf16_sv
			&& last.has_value()
			&& last.left() == u"\u00E9A"_utf16_sv
			&& last.right() == u""_utf16_sv;
	}());
	static_assert(std::same_as<
	...
	static_assert(std::same_as<
		...
		split_once_at_result<utf16_string_view>>);
	...
	static_assert(std::same_as<decltype(utf8_text.copy(static_cast<char8_t*>(nullptr), std::size_t{})), utf8_string_view::size_type>);
	...
	static_assert(!utf8_text.substr(0, 7).has_value());
	static_assert(utf8_text.substr_unchecked(1) == "é€"_utf8_sv);
	static_assert(utf8_text.substr_unchecked(1, 2) == "é"_utf8_sv);
	...
	static_assert([] {
		...
		return first.has_value()
			&& first.left() == u8"abra"_utf8_sv
			&& first.right() == u8"cadabra--!"_utf8_sv
			&& last.has_value()
			&& last.left() == u8"abra--cadabra"_utf8_sv
			&& last.right() == u8"!"_utf8_sv
	...
	static_assert([] {
		...
		return std::ranges::equal(empty.split(u8"--"_utf8_sv), std::array{
			...
			&& exact_first.left() == u8""_utf8_sv
			&& exact_first.right() == u8""_utf8_sv
			&& exact_last.has_value()
			&& exact_last.left() == u8""_utf8_sv
			&& exact_last.right() == u8""_utf8_sv
			...
			&& unicode_first.left() == u8"A"_utf8_sv
			&& unicode_first.right() == u8"B\u00E9"_utf8_sv
			&& unicode_last.has_value()
			&& unicode_last.left() == u8"A\u00E9B"_utf8_sv
			&& unicode_last.right() == u8""_utf8_sv;
	}());
	static_assert([] {
		constexpr auto empty = u8""_utf8_sv;
		...
		constexpr auto unicode = u8"A\u00E9B\u00E9"_utf8_sv;
		constexpr auto mixed = u8"A\u00E9B"_utf8_sv;
		return std::ranges::equal(empty.split_inclusive(u8"--"_utf8_sv), std::array{
			...
			&& std::ranges::equal(u8"aaaa"_utf8_sv.match_indices(u8"aa"_utf8_sv), std::array{
				std::pair<std::size_t, utf8_string_view>{ 0, u8"aa"_utf8_sv },
				std::pair<std::size_t, utf8_string_view>{ 2, u8"aa"_utf8_sv }
			})
			&& std::ranges::equal(u8"A1B2"_utf8_sv.match_indices([](utf8_char ch) noexcept { return ch.is_ascii_digit(); }), std::array{
				std::pair<std::size_t, utf8_string_view>{ 1, u8"1"_utf8_sv },
				std::pair<std::size_t, utf8_string_view>{ 3, u8"2"_utf8_sv }
			})
			&& std::ranges::equal(mixed.matches(std::array{ u8"A"_u8c, u8"\u00E9"_u8c }), std::array{
				u8"A"_utf8_sv,
				u8"\u00E9"_utf8_sv
			})
			&& std::ranges::equal(mixed.match_indices(std::array{ u8"A"_u8c, u8"\u00E9"_u8c }), std::array{
				std::pair<std::size_t, utf8_string_view>{ 0, u8"A"_utf8_sv },
				std::pair<std::size_t, utf8_string_view>{ 1, u8"\u00E9"_utf8_sv }
			})
			&& std::ranges::equal(mixed.rmatches(std::array{ u8"A"_u8c, u8"\u00E9"_u8c }), std::array{
				u8"\u00E9"_utf8_sv,
				u8"A"_utf8_sv
			})
			&& std::ranges::equal(mixed.rmatch_indices(std::array{ u8"A"_u8c, u8"\u00E9"_u8c }), std::array{
				std::pair<std::size_t, utf8_string_view>{ 1, u8"\u00E9"_utf8_sv },
				std::pair<std::size_t, utf8_string_view>{ 0, u8"A"_utf8_sv }
			})
			...
			&& std::ranges::equal(u8"abra"_utf8_sv.match_indices(u8""_utf8_sv), std::array<std::pair<std::size_t, utf8_string_view>, 0>{})
	...
	static_assert([] {
		...
		return parts.left() == u8"A"_utf8_sv && parts.right() == u8"\u00E9\u20AC"_utf8_sv;
	}());
	static_assert([] {
		constexpr auto text = u8"A\u00E9\u20AC"_utf8_sv;
	...
	static_assert([] {
		constexpr auto text = u8"name=value"_utf8_sv;
		const auto split = text.split_once(u8"="_u8c);
		const auto missing = text.split_once(u8":"_u8c);
		const auto [left, right] = split;
		return split
			&& left == u8"name"_utf8_sv
			&& right == u8"value"_utf8_sv
			&& !missing
			&& missing.left() == text
			&& missing.right() == text;
	}());
	static_assert([] {
		...
		const auto split = text.split_once(u8"="_u8c);
		const auto missing = text.split_once(u8":"_u8c);
		constexpr std::array expected{ u8"name"_utf8_sv, u8"value"_utf8_sv };
		return std::ranges::equal(split, expected)
			&& std::ranges::size(split) == 2
			&& std::ranges::empty(missing)
			&& std::ranges::size(missing) == 0;
	}());
	static_assert([] {
		constexpr std::array inputs{ u8"a=b"_utf8_sv, u8"c=d"_utf8_sv, u8"missing"_utf8_sv };
		auto flattened = inputs
			| std::views::transform([](utf8_string_view text) static constexpr noexcept
				{
					return text.split_once(u8"="_u8c);
				})
			| std::views::join;
		return std::ranges::equal(flattened, std::array{
			u8"a"_utf8_sv,
			u8"b"_utf8_sv,
			u8"c"_utf8_sv,
			u8"d"_utf8_sv
	...
	static_assert([] {
		...
		const auto invalid = text.split_once_at(2);
		const auto empty_split = utf8_string_view{}.split_once_at(0);
		const auto [left, right] = split;
		return split
			&& split.has_value()
			&& left == u8"A"_utf8_sv
			...
			&& invalid.right() == text
			&& empty_split
			&& empty_split.has_value()
			&& empty_split.left() == utf8_string_view{}
			&& empty_split.right() == utf8_string_view{};
	}());
	static_assert([] {
		constexpr auto text = u8"A\u00E9\u20AC"_utf8_sv;
		const auto split = text.split_once_at(1);
		const auto invalid = text.split_once_at(2);
		constexpr std::array expected{ u8"A"_utf8_sv, u8"\u00E9\u20AC"_utf8_sv };
		return std::ranges::equal(split, expected)
			&& std::ranges::size(split) == 2
			&& std::ranges::empty(invalid)
			&& std::ranges::size(invalid) == 0;
	}());
	static_assert([] {
		constexpr auto text = u8"A\u00E9\u20AC"_utf8_sv;
		...
		return parts
			&& parts.has_value()
			&& parts.left() == u8"A"_utf8_sv
			&& parts.right() == u8"\u00E9\u20AC"_utf8_sv
			&& std::ranges::equal(parts, expected)
			&& std::ranges::size(parts) == 2;
	}());
	static_assert([] {
		constexpr auto text = u8"e\u0301🇷🇴!"_utf8_sv;
		return text.grapheme_count() == 3
			...
			&& !text.grapheme_substr(3, 10).has_value();
	}());

	// utf16_string_view mirrors the utf8_string_view API, but with UTF-16 code-unit semantics.
	static_assert(utf16_text.size() == 4);
	static_assert(std::same_as<decltype(utf16_text.copy(static_cast<char16_t*>(nullptr), std::size_t{})), utf16_string_view::size_type>);
	...
	static_assert(!utf16_text.substr(0, 5).has_value());
	static_assert(utf16_text.substr_unchecked(1) == u"é😀"_utf16_sv);
	static_assert(utf16_text.substr_unchecked(2, 2) == u"😀"_utf16_sv);
	...
	static_assert([] {
		...
		return first.has_value()
			&& first.left() == u"abra"_utf16_sv
			&& first.right() == u"cadabra--!"_utf16_sv
			&& last.has_value()
			&& last.left() == u"abra--cadabra"_utf16_sv
			&& last.right() == u"!"_utf16_sv
	...
	static_assert([] {
		...
		return std::ranges::equal(empty.split(u"--"_utf16_sv), std::array{
			...
			&& exact_first.has_value()
			&& exact_first.left() == u""_utf16_sv
			&& exact_first.right() == u""_utf16_sv
			&& exact_last.has_value()
			&& exact_last.left() == u""_utf16_sv
			&& exact_last.right() == u""_utf16_sv
			...
			&& unicode_first.has_value()
			&& unicode_first.left() == u"A"_utf16_sv
			&& unicode_first.right() == u"B\u00E9"_utf16_sv
			&& unicode_last.has_value()
			&& unicode_last.left() == u"A\u00E9B"_utf16_sv
			&& unicode_last.right() == u""_utf16_sv;
	}());
	static_assert([] {
		constexpr auto empty = u""_utf16_sv;
		...
		constexpr auto unicode = u"A\u00E9B\u00E9"_utf16_sv;
		constexpr auto mixed = u"A\U0001F600B"_utf16_sv;
		return std::ranges::equal(empty.split_inclusive(u"--"_utf16_sv), std::array{
			...
			&& std::ranges::equal(u"aaaa"_utf16_sv.match_indices(u"aa"_utf16_sv), std::array{
				std::pair<std::size_t, utf16_string_view>{ 0, u"aa"_utf16_sv },
				std::pair<std::size_t, utf16_string_view>{ 2, u"aa"_utf16_sv }
			})
			&& std::ranges::equal(u"A1B2"_utf16_sv.match_indices([](utf16_char ch) noexcept { return ch.is_ascii_digit(); }), std::array{
				std::pair<std::size_t, utf16_string_view>{ 1, u"1"_utf16_sv },
				std::pair<std::size_t, utf16_string_view>{ 3, u"2"_utf16_sv }
			})
			&& std::ranges::equal(mixed.matches(std::array{ u"A"_u16c, u"\U0001F600"_u16c }), std::array{
				u"A"_utf16_sv,
				u"\U0001F600"_utf16_sv
			})
			&& std::ranges::equal(mixed.match_indices(std::array{ u"A"_u16c, u"\U0001F600"_u16c }), std::array{
				std::pair<std::size_t, utf16_string_view>{ 0, u"A"_utf16_sv },
				std::pair<std::size_t, utf16_string_view>{ 1, u"\U0001F600"_utf16_sv }
			})
			&& std::ranges::equal(mixed.rmatches(std::array{ u"A"_u16c, u"\U0001F600"_u16c }), std::array{
				u"\U0001F600"_utf16_sv,
				u"A"_utf16_sv
			})
			&& std::ranges::equal(mixed.rmatch_indices(std::array{ u"A"_u16c, u"\U0001F600"_u16c }), std::array{
				std::pair<std::size_t, utf16_string_view>{ 1, u"\U0001F600"_utf16_sv },
				std::pair<std::size_t, utf16_string_view>{ 0, u"A"_utf16_sv }
			})
			...
			&& std::ranges::equal(u"abra"_utf16_sv.match_indices(u""_utf16_sv), std::array<std::pair<std::size_t, utf16_string_view>, 0>{})
	...
	static_assert([] {
		...
		const auto parts = text.split_once_at(1);
		if (!parts.has_value()) return false;
		return parts.left() == u"A"_utf16_sv && parts.right() == u"\u00E9\U0001F600"_utf16_sv;
	}());
	static_assert([] {
		constexpr auto text = u"A\u00E9\U0001F600"_utf16_sv;
	...
	static_assert([] {
		constexpr auto text = u"A\u00E9\U0001F600"_utf16_sv;
		const auto parts = text.split_once_at_unchecked(1);
		constexpr std::array expected{ u"A"_utf16_sv, u"\u00E9\U0001F600"_utf16_sv };
		return parts
			&& parts.has_value()
			&& parts.left() == u"A"_utf16_sv
			&& parts.right() == u"\u00E9\U0001F600"_utf16_sv
			&& std::ranges::equal(parts, expected)
			&& std::ranges::size(parts) == 2;
	}());
	static_assert([] {
		...
		return text.grapheme_count() == 3
			...
			&& !text.grapheme_substr(1, 2).has_value()
			&& !text.grapheme_substr(2, 6).has_value();
	}());
#if UTF8_RANGES_ENABLE_CONSTEXPR_STRINGS
	...
	UTF8_RANGES_TEST_ASSERT((std::same_as<
		pmr::utf32_string,
		basic_utf32_string<std::pmr::polymorphic_allocator<char32_t>>>));
	static_assert(std::swappable<utf8_string>);
	static_assert(std::swappable<utf16_string>);
	static_assert(std::swappable<utf32_string>);
	static_assert(noexcept(std::ranges::swap(std::declval<utf8_string&>(), std::declval<utf8_string&>())));
	static_assert(noexcept(std::ranges::swap(std::declval<utf16_string&>(), std::declval<utf16_string&>())));
	static_assert(noexcept(std::ranges::swap(std::declval<utf32_string&>(), std::declval<utf32_string&>())));
	{
		utf8_string lhs = u8"left"_utf8_s;
		utf8_string rhs = u8"right"_utf8_s;

		using std::swap;
		swap(lhs, rhs);
		UTF8_RANGES_TEST_ASSERT(lhs == u8"right"_utf8_sv);
		UTF8_RANGES_TEST_ASSERT(rhs == u8"left"_utf8_sv);

		std::ranges::swap(lhs, rhs);
		UTF8_RANGES_TEST_ASSERT(lhs == u8"left"_utf8_sv);
		UTF8_RANGES_TEST_ASSERT(rhs == u8"right"_utf8_sv);
	...
	{
		utf16_string lhs = u"left"_utf16_s;
		utf16_string rhs = u"right"_utf16_s;

		using std::swap;
		swap(lhs, rhs);
		UTF8_RANGES_TEST_ASSERT(lhs == u"right"_utf16_sv);
		UTF8_RANGES_TEST_ASSERT(rhs == u"left"_utf16_sv);

		std::ranges::swap(lhs, rhs);
		UTF8_RANGES_TEST_ASSERT(lhs == u"left"_utf16_sv);
		UTF8_RANGES_TEST_ASSERT(rhs == u"right"_utf16_sv);
	...
	{
		utf32_string lhs = U"left"_utf32_s;
		utf32_string rhs = U"right"_utf32_s;

		using std::swap;
		swap(lhs, rhs);
		UTF8_RANGES_TEST_ASSERT(lhs == U"right"_utf32_sv);
		UTF8_RANGES_TEST_ASSERT(rhs == U"left"_utf32_sv);

		std::ranges::swap(lhs, rhs);
		UTF8_RANGES_TEST_ASSERT(lhs == U"left"_utf32_sv);
		UTF8_RANGES_TEST_ASSERT(rhs == U"right"_utf32_sv);
...

	{
		...
		}
		{
			...
			replaced = std::move(replaced).replace_at(8, 4, std::move(source).chars());
		...
		}
		{
			...
			replaced = std::move(replaced).replace_at(8, 4, std::move(source).reversed_chars());
			UTF8_RANGES_TEST_ASSERT(replaced == u8"Ana are erem"_utf8_sv);
		}
		{
			auto source = u8"yz"_utf8_sv.to_utf8();
			auto replaced = u8"aXb"_utf8_s;
			replaced = std::move(replaced).replace_at(1, std::move(source).chars());
			UTF8_RANGES_TEST_ASSERT(replaced == u8"ayzb"_utf8_sv);
		}
		{
			auto source = u8"yz"_utf8_sv.to_utf8();
			auto replaced = u8"aXb"_utf8_s;
			replaced = std::move(replaced).replace_at(1, std::move(source).reversed_chars());
		...
		{
			auto text = U"e\u0301\U0001F1F7\U0001F1F4!"_utf32_sv.to_utf32();
		...
		{
			std::array<char8_t, 8> buffer{};

			const auto copied_char = runtime_utf8_text.copy(buffer.data(), 2, 1);
			UTF8_RANGES_TEST_ASSERT(copied_char == 2);
			UTF8_RANGES_TEST_ASSERT(std::u8string_view{ buffer.data(), copied_char } == std::u8string_view{ u8"\u00E9" });

			const auto copied_tail = runtime_utf8_text.copy(buffer.data(), utf8_string_view::npos, 3);
			UTF8_RANGES_TEST_ASSERT(copied_tail == 3);
			UTF8_RANGES_TEST_ASSERT(std::u8string_view{ buffer.data(), copied_tail } == std::u8string_view{ u8"\u20AC" });

			const auto copied_empty = runtime_utf8_text.copy(buffer.data(), 1, runtime_utf8_text.size());
			UTF8_RANGES_TEST_ASSERT(copied_empty == 0);
		}
		...
		UTF8_RANGES_TEST_ASSERT(!runtime_utf8_text.substr(0, 7).has_value());
		UTF8_RANGES_TEST_ASSERT(runtime_utf8_text.substr_unchecked(1) == u8"\u00E9\u20AC"_utf8_sv);
		UTF8_RANGES_TEST_ASSERT(runtime_utf8_text.substr_unchecked(1, 2) == u8"\u00E9"_utf8_sv);
		...
		}
		{
			...
			auto expanding_lower_owned = u8"\u00C4\u03A9\u0130!"_utf8_s;
			[[maybe_unused]] auto expanding_lowered = std::move(expanding_lower_owned).to_lowercase();
			UTF8_RANGES_TEST_ASSERT(expanding_lowered == u8"\u00E4\u03C9i\u0307!"_utf8_sv);
			auto expanding_upper_owned = u8"\u00E4\u00DF\u03C9!"_utf8_s;
			[[maybe_unused]] auto expanding_uppered = std::move(expanding_upper_owned).to_uppercase();
			UTF8_RANGES_TEST_ASSERT(expanding_uppered == u8"\u00C4SS\u03A9!"_utf8_sv);
			auto expanding_fold_owned = u8"Stra\u00DFe!"_utf8_s;
			[[maybe_unused]] auto expanding_folded = std::move(expanding_fold_owned).case_fold();
			UTF8_RANGES_TEST_ASSERT(expanding_folded == u8"strasse!"_utf8_sv);
		...
		}
		{
			...
			UTF8_RANGES_TEST_ASSERT(first.left() == u8"abra"_utf8_sv);
			UTF8_RANGES_TEST_ASSERT(first.right() == u8"cadabra--!"_utf8_sv);
			[[maybe_unused]] const auto last = text.rsplit_once(u8"--"_utf8_sv);
			UTF8_RANGES_TEST_ASSERT(last.has_value());
			UTF8_RANGES_TEST_ASSERT(last.left() == u8"abra--cadabra"_utf8_sv);
			UTF8_RANGES_TEST_ASSERT(last.right() == u8"!"_utf8_sv);
		...
		}
		{
			...
			UTF8_RANGES_TEST_ASSERT(exact_first.left() == u8""_utf8_sv);
			UTF8_RANGES_TEST_ASSERT(exact_first.right() == u8""_utf8_sv);
			[[maybe_unused]] const auto exact_last = exact.rsplit_once(u8"--"_utf8_sv);
			UTF8_RANGES_TEST_ASSERT(exact_last.has_value());
			UTF8_RANGES_TEST_ASSERT(exact_last.left() == u8""_utf8_sv);
			UTF8_RANGES_TEST_ASSERT(exact_last.right() == u8""_utf8_sv);
			...
			UTF8_RANGES_TEST_ASSERT(unicode_first.left() == u8"A"_utf8_sv);
			UTF8_RANGES_TEST_ASSERT(unicode_first.right() == u8"B\u00E9"_utf8_sv);
			[[maybe_unused]] const auto unicode_last = unicode.rsplit_once(u8"\u00E9"_u8c);
			UTF8_RANGES_TEST_ASSERT(unicode_last.has_value());
			UTF8_RANGES_TEST_ASSERT(unicode_last.left() == u8"A\u00E9B"_utf8_sv);
			UTF8_RANGES_TEST_ASSERT(unicode_last.right() == u8""_utf8_sv);
		}
		{
			[[maybe_unused]] const auto empty = u8""_utf8_sv;
			...
			UTF8_RANGES_TEST_ASSERT(std::ranges::equal(u8"aaaa"_utf8_sv.match_indices(u8"aa"_utf8_sv), std::array{
				std::pair<std::size_t, utf8_string_view>{ 0, u8"aa"_utf8_sv },
				std::pair<std::size_t, utf8_string_view>{ 2, u8"aa"_utf8_sv }
			}));
			...
			UTF8_RANGES_TEST_ASSERT(std::ranges::equal(u8"abra"_utf8_sv.match_indices(u8""_utf8_sv), std::array<std::pair<std::size_t, utf8_string_view>, 0>{}));
		...
		}
		{
			...
			UTF8_RANGES_TEST_ASSERT(first.has_value());
			UTF8_RANGES_TEST_ASSERT(first.left() == u8""_utf8_sv);
			UTF8_RANGES_TEST_ASSERT(first.right() == u8"A\u20AC"_utf8_sv);
			[[maybe_unused]] const auto last = text.rsplit_once(any);
			UTF8_RANGES_TEST_ASSERT(last.has_value());
			UTF8_RANGES_TEST_ASSERT(last.left() == u8"\u00E9A"_utf8_sv);
			UTF8_RANGES_TEST_ASSERT(last.right() == u8""_utf8_sv);
		...
		}
		{
			...
			UTF8_RANGES_TEST_ASSERT(split.left() == u8"A"_utf8_sv);
			UTF8_RANGES_TEST_ASSERT(split.right() == u8"\u00E9\u20AC"_utf8_sv);
			UTF8_RANGES_TEST_ASSERT(!text.split_once_at(2).has_value());
			[[maybe_unused]] const auto unchecked = text.split_once_at_unchecked(1);
			UTF8_RANGES_TEST_ASSERT(unchecked.has_value());
			UTF8_RANGES_TEST_ASSERT(unchecked.left() == u8"A"_utf8_sv);
			UTF8_RANGES_TEST_ASSERT(unchecked.right() == u8"\u00E9\u20AC"_utf8_sv);
			UTF8_RANGES_TEST_ASSERT(std::ranges::size(unchecked) == 2);
		}
		{
			const std::u8string text_storage = u8"e\u0301\U0001F1F7\U0001F1F4!";
			[[maybe_unused]] const auto text = unwrap_utf8_view(text_storage);
			...
			UTF8_RANGES_TEST_ASSERT(!text.grapheme_substr(3, 10).has_value());
		}
		...
		}
		{
			...
			const auto copied_char = runtime_utf16_text.copy(buffer.data(), 1, 1);
			UTF8_RANGES_TEST_ASSERT(copied_char == 1);
			UTF8_RANGES_TEST_ASSERT(std::u16string_view{ buffer.data(), copied_char } == std::u16string_view{ u"\u00E9" });

			const auto copied_tail = runtime_utf16_text.copy(buffer.data(), utf16_string_view::npos, 2);
			UTF8_RANGES_TEST_ASSERT(copied_tail == 2);
			UTF8_RANGES_TEST_ASSERT(std::u16string_view{ buffer.data(), copied_tail } == std::u16string_view{ u"\U0001F600" });

			const auto copied_empty = runtime_utf16_text.copy(buffer.data(), 1, runtime_utf16_text.size());
			UTF8_RANGES_TEST_ASSERT(copied_empty == 0);
		}
		...
		UTF8_RANGES_TEST_ASSERT(!runtime_utf16_text.substr(0, 5).has_value());
		UTF8_RANGES_TEST_ASSERT(runtime_utf16_text.substr_unchecked(1) == u"\u00E9\U0001F600"_utf16_sv);
		UTF8_RANGES_TEST_ASSERT(runtime_utf16_text.substr_unchecked(2, 2) == u"\U0001F600"_utf16_sv);
		...
		{
			std::array<char32_t, 3> buffer{};

			const auto copied_tail = runtime_utf32_text.copy(buffer.data(), utf32_string_view::npos, 1);
			UTF8_RANGES_TEST_ASSERT(copied_tail == 2);
			UTF8_RANGES_TEST_ASSERT(std::u32string_view{ buffer.data(), copied_tail } == std::u32string_view{ U"\u00E9\U0001F600" });

			const auto copied_empty = runtime_utf32_text.copy(buffer.data(), 1, runtime_utf32_text.size());
			UTF8_RANGES_TEST_ASSERT(copied_empty == 0);
		}
		...
		UTF8_RANGES_TEST_ASSERT(!runtime_utf32_text.substr(0, 4).has_value());
		UTF8_RANGES_TEST_ASSERT(runtime_utf32_text.substr_unchecked(1) == U"\u00E9\U0001F600"_utf32_sv);
		UTF8_RANGES_TEST_ASSERT(runtime_utf32_text.substr_unchecked(2, 1) == U"\U0001F600"_utf32_sv);
		...
		{
			auto text = u8"é😀!"_utf8_s;
			text.reserve(128);
			const auto capacity = text.capacity();
			const auto suffix = std::move(text).substr_unchecked(2);
			UTF8_RANGES_TEST_ASSERT(suffix == u8"😀!"_utf8_sv);
		...
		UTF8_RANGES_TEST_ASSERT(U"e\u0301"_grapheme_utf32 == U"e\u0301"_utf32_sv);
		{
			...
			auto expanding_lower_owned = U"\u00C4\u03A9\u0130!"_utf32_s;
			[[maybe_unused]] auto expanding_lowered = std::move(expanding_lower_owned).to_lowercase();
			UTF8_RANGES_TEST_ASSERT(expanding_lowered == U"\u00E4\u03C9i\u0307!"_utf32_sv);
			auto expanding_upper_owned = U"\u00E4\u00DF\u03C9!"_utf32_s;
			[[maybe_unused]] auto expanding_uppered = std::move(expanding_upper_owned).to_uppercase();
			UTF8_RANGES_TEST_ASSERT(expanding_uppered == U"\u00C4SS\u03A9!"_utf32_sv);
			auto expanding_fold_owned = U"Stra\u00DFe!"_utf32_s;
			[[maybe_unused]] auto expanding_folded = std::move(expanding_fold_owned).case_fold();
			UTF8_RANGES_TEST_ASSERT(expanding_folded == U"strasse!"_utf32_sv);
			std::pmr::monotonic_buffer_resource resource;
		...
		}
		{
			...
			UTF8_RANGES_TEST_ASSERT(first.right() == U"cadabra--!"_utf32_sv);
			[[maybe_unused]] const auto last = text.rsplit_once(U"--"_utf32_sv);
			UTF8_RANGES_TEST_ASSERT(last.has_value());
			UTF8_RANGES_TEST_ASSERT(last.left() == U"abra--cadabra"_utf32_sv);
			UTF8_RANGES_TEST_ASSERT(last.right() == U"!"_utf32_sv);
		...
		}
		{
			...
			auto expanding_lower_owned = u"\u00C4\u03A9\u0130!"_utf16_s;
			[[maybe_unused]] auto expanding_lowered = std::move(expanding_lower_owned).to_lowercase();
			UTF8_RANGES_TEST_ASSERT(expanding_lowered == u"\u00E4\u03C9i\u0307!"_utf16_sv);
			auto expanding_upper_owned = u"\u00E4\u00DF\u03C9!"_utf16_s;
			[[maybe_unused]] auto expanding_uppered = std::move(expanding_upper_owned).to_uppercase();
			UTF8_RANGES_TEST_ASSERT(expanding_uppered == u"\u00C4SS\u03A9!"_utf16_sv);
			auto expanding_fold_owned = u"Stra\u00DFe!"_utf16_s;
			[[maybe_unused]] auto expanding_folded = std::move(expanding_fold_owned).case_fold();
			UTF8_RANGES_TEST_ASSERT(expanding_folded == u"strasse!"_utf16_sv);
			std::pmr::monotonic_buffer_resource resource;
		...
		}
		{
			...
			UTF8_RANGES_TEST_ASSERT(first.has_value());
			UTF8_RANGES_TEST_ASSERT(first.left() == u"abra"_utf16_sv);
			UTF8_RANGES_TEST_ASSERT(first.right() == u"cadabra--!"_utf16_sv);
			[[maybe_unused]] const auto last = text.rsplit_once(u"--"_utf16_sv);
			UTF8_RANGES_TEST_ASSERT(last.has_value());
			UTF8_RANGES_TEST_ASSERT(last.left() == u"abra--cadabra"_utf16_sv);
			UTF8_RANGES_TEST_ASSERT(last.right() == u"!"_utf16_sv);
		...
		}
		{
			...
			UTF8_RANGES_TEST_ASSERT(exact_first.has_value());
			UTF8_RANGES_TEST_ASSERT(exact_first.left() == u""_utf16_sv);
			UTF8_RANGES_TEST_ASSERT(exact_first.right() == u""_utf16_sv);
			[[maybe_unused]] const auto exact_last = exact.rsplit_once(u"--"_utf16_sv);
			UTF8_RANGES_TEST_ASSERT(exact_last.has_value());
			UTF8_RANGES_TEST_ASSERT(exact_last.left() == u""_utf16_sv);
			UTF8_RANGES_TEST_ASSERT(exact_last.right() == u""_utf16_sv);
			...
			UTF8_RANGES_TEST_ASSERT(unicode_first.has_value());
			UTF8_RANGES_TEST_ASSERT(unicode_first.left() == u"A"_utf16_sv);
			UTF8_RANGES_TEST_ASSERT(unicode_first.right() == u"B\u00E9"_utf16_sv);
			[[maybe_unused]] const auto unicode_last = unicode.rsplit_once(u"\u00E9"_u16c);
			UTF8_RANGES_TEST_ASSERT(unicode_last.has_value());
			UTF8_RANGES_TEST_ASSERT(unicode_last.left() == u"A\u00E9B"_utf16_sv);
			UTF8_RANGES_TEST_ASSERT(unicode_last.right() == u""_utf16_sv);
		}
		{
			[[maybe_unused]] const auto empty = u""_utf16_sv;
			...
			UTF8_RANGES_TEST_ASSERT(std::ranges::equal(u"aaaa"_utf16_sv.match_indices(u"aa"_utf16_sv), std::array{
				std::pair<std::size_t, utf16_string_view>{ 0, u"aa"_utf16_sv },
				std::pair<std::size_t, utf16_string_view>{ 2, u"aa"_utf16_sv }
			}));
			...
			UTF8_RANGES_TEST_ASSERT(std::ranges::equal(u"abra"_utf16_sv.match_indices(u""_utf16_sv), std::array<std::pair<std::size_t, utf16_string_view>, 0>{}));
		...
		}
		{
			...
			[[maybe_unused]] const auto first = text.split_once(any);
			UTF8_RANGES_TEST_ASSERT(first.has_value());
			UTF8_RANGES_TEST_ASSERT(first.left() == u""_utf16_sv);
			UTF8_RANGES_TEST_ASSERT(first.right() == u"A\U0001F600"_utf16_sv);
			[[maybe_unused]] const auto last = text.rsplit_once(any);
			UTF8_RANGES_TEST_ASSERT(last.has_value());
			UTF8_RANGES_TEST_ASSERT(last.left() == u"\u00E9A"_utf16_sv);
			UTF8_RANGES_TEST_ASSERT(last.right() == u""_utf16_sv);
		...
		}
		{
			...
			[[maybe_unused]] const auto split = text.split_once_at(1);
			UTF8_RANGES_TEST_ASSERT(split.has_value());
			UTF8_RANGES_TEST_ASSERT(split.left() == u"A"_utf16_sv);
			UTF8_RANGES_TEST_ASSERT(split.right() == u"\u00E9\U0001F600"_utf16_sv);
			UTF8_RANGES_TEST_ASSERT(!text.split_once_at(3).has_value());
			[[maybe_unused]] const auto unchecked = text.split_once_at_unchecked(1);
			UTF8_RANGES_TEST_ASSERT(unchecked.has_value());
			UTF8_RANGES_TEST_ASSERT(unchecked.left() == u"A"_utf16_sv);
			UTF8_RANGES_TEST_ASSERT(unchecked.right() == u"\u00E9\U0001F600"_utf16_sv);
			UTF8_RANGES_TEST_ASSERT(std::ranges::size(unchecked) == 2);
		}
		{
			const std::u16string text_storage = u"e\u0301\U0001F1F7\U0001F1F4!";
			...
			UTF8_RANGES_TEST_ASSERT(!text.grapheme_substr(1, 2).has_value());
			UTF8_RANGES_TEST_ASSERT(!text.grapheme_substr(2, 6).has_value());
		}
	}
...
static_assert(std::same_as<decltype(utf8_string{}.copy(static_cast<char8_t*>(nullptr), std::size_t{})), utf8_string::size_type>);
...
#else
{
	...
	{
		const std::wstring invalid(1, static_cast<wchar_t>(0xD800u));
		const auto result = utf8_string::from_bytes(std::wstring_view{ invalid });
		UTF8_RANGES_TEST_ASSERT(!result.has_value());
		if constexpr (sizeof(wchar_t) == 2)
		{
			UTF8_RANGES_TEST_ASSERT(result.error().code == wide_string_error_code::truncated_surrogate_pair);
		}
		else
		{
			UTF8_RANGES_TEST_ASSERT(result.error().code == wide_string_error_code::invalid_scalar);
		}
		UTF8_RANGES_TEST_ASSERT(result.error().first_invalid_element_index == 0);
	}
	...
	{
		auto text = u8"A\u00E9\U0001F600"_utf8_s;
		std::array<char8_t, 8> buffer{};

		const auto copied_char = text.copy(buffer.data(), 2, 1);
		UTF8_RANGES_TEST_ASSERT(copied_char == 2);
		UTF8_RANGES_TEST_ASSERT(std::u8string_view{ buffer.data(), copied_char } == std::u8string_view{ u8"\u00E9" });

		const auto copied_tail = text.copy(buffer.data(), decltype(text)::npos, 3);
		UTF8_RANGES_TEST_ASSERT(copied_tail == 4);
		UTF8_RANGES_TEST_ASSERT(std::u8string_view{ buffer.data(), copied_tail } == std::u8string_view{ u8"\U0001F600" });

		const auto copied_clamped = text.copy(buffer.data(), 100, 1);
		UTF8_RANGES_TEST_ASSERT(copied_clamped == 6);
		UTF8_RANGES_TEST_ASSERT(std::u8string_view{ buffer.data(), copied_clamped } == std::u8string_view{ u8"\u00E9\U0001F600" });
	}
	{
	...
	{
		auto s = u8"Aé"_utf8_s;
		s = std::move(s).replace_at(0, 1, s.as_view());
		UTF8_RANGES_TEST_ASSERT(s == u8"Aéé"_utf8_sv);
	}
	{
		auto s = u8"Aé"_utf8_s;
		s = std::move(s).replace_at(0, s.as_view());
		UTF8_RANGES_TEST_ASSERT(s == u8"Aéé"_utf8_sv);
	}
	{
		auto s = u8"Aé"_utf8_s;
		s = std::move(s).replace_at(0, 1, s.chars());
		UTF8_RANGES_TEST_ASSERT(s == u8"Aéé"_utf8_sv);
	}
	{
		auto s = u8"Aé"_utf8_s;
		s = std::move(s).replace_at(0, s.chars());
		UTF8_RANGES_TEST_ASSERT(s == u8"Aéé"_utf8_sv);
	}
	{
		auto s = u8"A\u00E9"_utf8_s;
		auto suffix_chars = s.chars() | std::views::drop(1);
		s = std::move(s).replace_at(0, suffix_chars);
		UTF8_RANGES_TEST_ASSERT(s == u8"\u00E9\u00E9"_utf8_sv);
	}
	{
		auto s = u8"Aé"_utf8_s;
	...
	}
	{
		auto s = u8"A"_utf8_s;
		s.append(2, u8"\u20AC"_u8c);
		UTF8_RANGES_TEST_ASSERT(s == u8"A\u20AC\u20AC"_utf8_sv);
	}
	{
		auto s = u8"A!"_utf8_s;
	...
	}
	{
		auto s = u8"A!"_utf8_s;
		s.reserve(64);
		const auto* original = s.base().data();
		s.insert_range(1, std::array{ u8"\u00E9"_u8c, u8"\U0001F600"_u8c });
		UTF8_RANGES_TEST_ASSERT(s == u8"A\u00E9\U0001F600!"_utf8_sv);
		UTF8_RANGES_TEST_ASSERT(s.base().data() == original);
	}
	{
		auto s = u8"A!"_utf8_s;
		s = std::move(s).replace_at(1, 1, u"\u00E9\U0001F600"_utf16_sv.chars());
		UTF8_RANGES_TEST_ASSERT(s == u8"A\u00E9\U0001F600"_utf8_sv);
	}
	{
		auto s = u8"A!"_utf8_s;
		s = std::move(s).replace_at(1, 1, U"\u00E9\U0001F600"_utf32_sv.chars());
		UTF8_RANGES_TEST_ASSERT(s == u8"A\u00E9\U0001F600"_utf8_sv);
	}
	{
		auto s = u8"A!"_utf8_s;
		s = std::move(s).replace_at(1, U"\u00E9\U0001F600"_utf32_sv.chars());
		UTF8_RANGES_TEST_ASSERT(s == u8"A\u00E9\U0001F600"_utf8_sv);
	}
	{
		auto s = u8"A!"_utf8_s;
		s.reserve(64);
		const auto* original = s.base().data();
		s = std::move(s).replace_at(1, 1, std::array{ u8"\u00E9"_u8c, u8"\U0001F600"_u8c });
		UTF8_RANGES_TEST_ASSERT(s == u8"A\u00E9\U0001F600"_utf8_sv);
		UTF8_RANGES_TEST_ASSERT(s.base().data() == original);
	}
	{
		unicode_ranges_test_details::counting_memory_resource resource;
		auto alloc = std::pmr::polymorphic_allocator<char8_t>{ &resource };
		unicode_ranges::pmr::utf8_string s{ alloc };
		s.assign(u8"A!"_utf8_sv);
		s.reserve(64);

		resource.reset_counts();
		s.insert_range(1, std::array{ u8"\u00E9"_u8c, u8"\U0001F600"_u8c });
		UTF8_RANGES_TEST_ASSERT(s == u8"A\u00E9\U0001F600!"_utf8_sv);
		UTF8_RANGES_TEST_ASSERT(resource.allocations == 0);

		resource.reset_counts();
		[[maybe_unused]] auto replaced = std::move(s).replace_at(1, 6, std::array{ u8"\u00E9"_u8c, u8"\U0001F600"_u8c });
		UTF8_RANGES_TEST_ASSERT(replaced == u8"A\u00E9\U0001F600!"_utf8_sv);
	}
	{
		auto s = u8"abcdefghijklmnopqrstuvwxyz"_utf8_s;
		s.shrink_to_fit();
		auto prefix = s.as_view().chars() | std::views::take(3);
		s.append_range(prefix);
		UTF8_RANGES_TEST_ASSERT(s == u8"abcdefghijklmnopqrstuvwxyzabc"_utf8_sv);
	}
	{
		auto s = u8"abcd"_utf8_s;
		auto middle = s.as_view().chars() | std::views::drop(1) | std::views::take(2);
		s.insert_range(4, middle);
		UTF8_RANGES_TEST_ASSERT(s == u8"abcdbc"_utf8_sv);
	}
	{
		auto s = u8"A!"_utf8_s;
		s.reserve(64);
...
static_assert(std::same_as<decltype(utf16_string{}.copy(static_cast<char16_t*>(nullptr), std::size_t{})), utf16_string::size_type>);
...
#else
{
	...
	{
		auto text = u"A\u00E9\U0001F600"_utf16_s;
		std::array<char16_t, 4> buffer{};

		const auto copied_char = text.copy(buffer.data(), 1, 1);
		UTF8_RANGES_TEST_ASSERT(copied_char == 1);
		UTF8_RANGES_TEST_ASSERT(std::u16string_view{ buffer.data(), copied_char } == std::u16string_view{ u"\u00E9" });

		const auto copied_tail = text.copy(buffer.data(), decltype(text)::npos, 2);
		UTF8_RANGES_TEST_ASSERT(copied_tail == 2);
		UTF8_RANGES_TEST_ASSERT(std::u16string_view{ buffer.data(), copied_tail } == std::u16string_view{ u"\U0001F600" });

		const auto copied_clamped = text.copy(buffer.data(), 100, 1);
		UTF8_RANGES_TEST_ASSERT(copied_clamped == 3);
		UTF8_RANGES_TEST_ASSERT(std::u16string_view{ buffer.data(), copied_clamped } == std::u16string_view{ u"\u00E9\U0001F600" });
	}
	{
	...
	}
	{
		...
		auto suffix_chars = s.chars() | std::views::drop(1);
		s = std::move(s).replace_at(0, suffix_chars);
		UTF8_RANGES_TEST_ASSERT(s == u"\u00E9\u00E9"_utf16_sv);
	}
	{
		auto s = u"A"_utf16_s;
		s.append(2, u"\U0001F600"_u16c);
	...
	{
		auto s = u"Aé😀"_utf16_s;
		s = std::move(s).replace_at(1, 1, u"Ω"_utf16_sv);
		UTF8_RANGES_TEST_ASSERT(s == u"AΩ😀"_utf16_sv);
	}
	{
		auto s = u"Aé😀"_utf16_s;
		s = std::move(s).replace_at(1, 1, u"Ω"_u16c);
		UTF8_RANGES_TEST_ASSERT(s == u"AΩ😀"_utf16_sv);
	}
	{
		auto s = u"Aé😀"_utf16_s;
		s = std::move(s).replace_at(1, u"XYZ"_utf16_sv);
		UTF8_RANGES_TEST_ASSERT(s == u"AXYZ😀"_utf16_sv);
	}
	{
		auto s = u"Aé😀"_utf16_s;
		s = std::move(s).replace_at(1, u"Ω"_u16c);
		UTF8_RANGES_TEST_ASSERT(s == u"AΩ😀"_utf16_sv);
	}
	{
		auto s = u"Aé😀"_utf16_s;
		s = std::move(s).replace_at(1, 1, std::array{ u"Ω"_u16c, u"!"_u16c });
		UTF8_RANGES_TEST_ASSERT(s == u"AΩ!😀"_utf16_sv);
	}
	{
		auto s = u"Aé😀"_utf16_s;
		s = std::move(s).replace_at(1, std::array{ u"Ω"_u16c, u"!"_u16c });
		UTF8_RANGES_TEST_ASSERT(s == u"AΩ!😀"_utf16_sv);
	}
	{
		auto s = u"A\u00E9\U0001F600"_utf16_s;
		[[maybe_unused]] const auto replaced = s.replace_at(1, 1, u"Z"_utf16_sv);
		UTF8_RANGES_TEST_ASSERT(s == u"A\u00E9\U0001F600"_utf16_sv);
		UTF8_RANGES_TEST_ASSERT(replaced == u"AZ\U0001F600"_utf16_sv);
	}
	{
		const auto sv = u"A\u00E9\U0001F600"_utf16_sv;
		[[maybe_unused]] const auto replaced = sv.replace_at(1, u"Z"_u16c);
		UTF8_RANGES_TEST_ASSERT(replaced == u"AZ\U0001F600"_utf16_sv);
	}
	{
	...
	{
		auto s = u"abc"_utf16_s;
		s.reserve(64);
		[[maybe_unused]] const auto* original = s.base().data();
		[[maybe_unused]] auto replaced = std::move(s).replace_all(u"z"_u16c, u"yy"_utf16_sv);
		UTF8_RANGES_TEST_ASSERT(replaced == u"abc"_utf16_sv);
		UTF8_RANGES_TEST_ASSERT(replaced.base().data() == original);
	}
	{
		auto s = u"aaaa"_utf16_s;
	...
	}
	{
		...
		s.reserve(64);
		const auto* original = s.base().data();
		s.insert_range(1, std::array{ u"\u00E9"_u16c, u"\U0001F600"_u16c });
		UTF8_RANGES_TEST_ASSERT(s == u"A\u00E9\U0001F600!"_utf16_sv);
		UTF8_RANGES_TEST_ASSERT(s.base().data() == original);
	}
	{
		auto s = u"A!"_utf16_s;
		s = std::move(s).replace_at(1, 1, u8"\u00E9\U0001F600"_utf8_sv.chars());
		UTF8_RANGES_TEST_ASSERT(s == u"A\u00E9\U0001F600"_utf16_sv);
	}
	{
		auto s = u"A!"_utf16_s;
	...
	}
	{
		...
		s.reserve(64);
		const auto* original = s.base().data();
		s = std::move(s).replace_at(1, 1, std::array{ u"\u00E9"_u16c, u"\U0001F600"_u16c });
		UTF8_RANGES_TEST_ASSERT(s == u"A\u00E9\U0001F600"_utf16_sv);
		UTF8_RANGES_TEST_ASSERT(s.base().data() == original);
	}
	{
		unicode_ranges_test_details::counting_memory_resource resource;
		auto alloc = std::pmr::polymorphic_allocator<char16_t>{ &resource };
		unicode_ranges::pmr::utf16_string s{ alloc };
		s.assign(u"A!"_utf16_sv);
		s.reserve(64);
		...
		resource.reset_counts();
		[[maybe_unused]] auto replaced = std::move(s).replace_at(1, 3, std::array{ u"\u00E9"_u16c, u"\U0001F600"_u16c });
		UTF8_RANGES_TEST_ASSERT(replaced == u"A\u00E9\U0001F600!"_utf16_sv);
	}
	{
		auto s = u"abcdefghijklmnopqrstuvwxyz"_utf16_s;
		s.shrink_to_fit();
		auto prefix = s.as_view().chars() | std::views::take(3);
		s.append_range(prefix);
		UTF8_RANGES_TEST_ASSERT(s == u"abcdefghijklmnopqrstuvwxyzabc"_utf16_sv);
	}
	{
		auto s = u"abcd"_utf16_s;
		auto middle = s.as_view().chars() | std::views::drop(1) | std::views::take(2);
		s.insert_range(4, middle);
		UTF8_RANGES_TEST_ASSERT(s == u"abcdbc"_utf16_sv);
	}
	{
		auto s = u"A!"_utf16_s;
		s.reserve(64);
	...
	static_assert(std::same_as<decltype(utf32_string{}.copy(static_cast<char32_t*>(nullptr), std::size_t{})), utf32_string::size_type>);
	...
	{
		auto text = U"A\u00E9\U0001F600"_utf32_s;
		std::array<char32_t, 3> buffer{};

		const auto copied_tail = text.copy(buffer.data(), decltype(text)::npos, 1);
		UTF8_RANGES_TEST_ASSERT(copied_tail == 2);
		UTF8_RANGES_TEST_ASSERT(std::u32string_view{ buffer.data(), copied_tail } == std::u32string_view{ U"\u00E9\U0001F600" });

		const auto copied_clamped = text.copy(buffer.data(), 100, 2);
		UTF8_RANGES_TEST_ASSERT(copied_clamped == 1);
		UTF8_RANGES_TEST_ASSERT(std::u32string_view{ buffer.data(), copied_clamped } == std::u32string_view{ U"\U0001F600" });
	}
	...
	{
		auto s = U"Aé😀"_utf32_s;
		s = std::move(s).replace_at(1, 1, U"Ω"_utf32_sv);
		UTF8_RANGES_TEST_ASSERT(s == U"AΩ😀"_utf32_sv);
	}
	{
		auto s = U"A\u00E9\U0001F600"_utf32_s;
		[[maybe_unused]] const auto replaced = s.replace_at(1, 1, U"Z"_utf32_sv);
		UTF8_RANGES_TEST_ASSERT(s == U"A\u00E9\U0001F600"_utf32_sv);
		UTF8_RANGES_TEST_ASSERT(replaced == U"AZ\U0001F600"_utf32_sv);
	}
	{
		const auto sv = U"A\u00E9\U0001F600"_utf32_sv;
		[[maybe_unused]] const auto replaced = sv.replace_at(1, U"Z"_u32c);
		UTF8_RANGES_TEST_ASSERT(replaced == U"AZ\U0001F600"_utf32_sv);
	}
	{
		auto s = U"A\u00E9"_utf32_s;
		auto suffix_chars = s.chars() | std::views::drop(1);
		s = std::move(s).replace_at(0, suffix_chars);
		UTF8_RANGES_TEST_ASSERT(s == U"\u00E9\u00E9"_utf32_sv);
	}
	{
		auto s = U"A"_utf32_s;
		s.append(2, U"\U0001F600"_u32c);
		UTF8_RANGES_TEST_ASSERT(s == U"A\U0001F600\U0001F600"_utf32_sv);
	}
	{
		auto s = U"abc"_utf32_s;
		s.reserve(64);
		[[maybe_unused]] const auto* original = s.base().data();
	...
	}
	{
		...
		s.reserve(64);
		const auto* original = s.base().data();
		s.insert_range(1, std::array{ U"\u00E9"_u32c, U"\U0001F600"_u32c });
		UTF8_RANGES_TEST_ASSERT(s == U"A\u00E9\U0001F600!"_utf32_sv);
		UTF8_RANGES_TEST_ASSERT(s.base().data() == original);
	}
	{
	...
	{
		auto s = U"A!"_utf32_s;
		s = std::move(s).replace_at(1, u"\u00E9\U0001F600"_utf16_sv.chars());
		UTF8_RANGES_TEST_ASSERT(s == U"A\u00E9\U0001F600"_utf32_sv);
	}
	{
		auto s = U"A!"_utf32_s;
		s.reserve(64);
		const auto* original = s.base().data();
		s = std::move(s).replace_at(1, 1, std::array{ U"\u00E9"_u32c, U"\U0001F600"_u32c });
		UTF8_RANGES_TEST_ASSERT(s == U"A\u00E9\U0001F600"_utf32_sv);
		UTF8_RANGES_TEST_ASSERT(s.base().data() == original);
	}
	{
		unicode_ranges_test_details::counting_memory_resource resource;
		auto alloc = std::pmr::polymorphic_allocator<char32_t>{ &resource };
		unicode_ranges::pmr::utf32_string s{ alloc };
		s.assign(U"A!"_utf32_sv);
		s.reserve(64);
		...
		resource.reset_counts();
		[[maybe_unused]] auto replaced = std::move(s).replace_at(1, 2, std::array{ U"\u00E9"_u32c, U"\U0001F600"_u32c });
		UTF8_RANGES_TEST_ASSERT(replaced == U"A\u00E9\U0001F600!"_utf32_sv);
	}
	{
		auto s = U"abcdefghijklmnopqrstuvwxyz"_utf32_s;
		s.shrink_to_fit();
		auto prefix = s.as_view().chars() | std::views::take(3);
		s.append_range(prefix);
		UTF8_RANGES_TEST_ASSERT(s == U"abcdefghijklmnopqrstuvwxyzabc"_utf32_sv);
	}
	{
		auto s = U"abcd"_utf32_s;
		auto middle = s.as_view().chars() | std::views::drop(1) | std::views::take(2);
		s.insert_range(4, middle);
		UTF8_RANGES_TEST_ASSERT(s == U"abcdbc"_utf32_sv);
	}
	{
		auto s = U"A!"_utf32_s;
		s.reserve(64);
	...
	{
		auto s = "Aé€"_utf8_s;
		s = std::move(s).replace_at(1, 2, "Ω"_utf8_sv);
		UTF8_RANGES_TEST_ASSERT(s == "AΩ€"_utf8_sv);
	}
	{
		auto s = "Aé€"_utf8_s;
		s = std::move(s).replace_at(1, 2, "Ω"_u8c);
		UTF8_RANGES_TEST_ASSERT(s == "AΩ€"_utf8_sv);
	}
	{
		auto s = "Aé€"_utf8_s;
		s = std::move(s).replace_at(1, "XYZ"_utf8_sv);
		UTF8_RANGES_TEST_ASSERT(s == "AXYZ€"_utf8_sv);
	}
	{
		auto s = "Aé€"_utf8_s;
		s = std::move(s).replace_at(1, "Ω"_u8c);
		UTF8_RANGES_TEST_ASSERT(s == "AΩ€"_utf8_sv);
	}
	{
		auto s = "Aé€"_utf8_s;
		s = std::move(s).replace_at(1, 2, std::array{ "Ω"_u8c, "!"_u8c });
		UTF8_RANGES_TEST_ASSERT(s == "AΩ!€"_utf8_sv);
	}
	{
		auto s = "Aé€"_utf8_s;
		s = std::move(s).replace_at(1, std::array{ "Ω"_u8c, "!"_u8c });
		UTF8_RANGES_TEST_ASSERT(s == "AΩ!€"_utf8_sv);
	}
	{
		auto s = u8"A\u00E9\u20AC"_utf8_s;
		[[maybe_unused]] const auto replaced = s.replace_at(1, 2, u8"Z"_utf8_sv);
		UTF8_RANGES_TEST_ASSERT(s == u8"A\u00E9\u20AC"_utf8_sv);
		UTF8_RANGES_TEST_ASSERT(replaced == u8"AZ\u20AC"_utf8_sv);
	}
	{
		const auto sv = u8"A\u00E9\u20AC"_utf8_sv;
		[[maybe_unused]] const auto replaced = sv.replace_at(1, u8"Z"_u8c);
		UTF8_RANGES_TEST_ASSERT(replaced == u8"AZ\u20AC"_utf8_sv);
	}
	{
	...
	{
		auto s = u8"abc"_utf8_s;
		s.reserve(64);
		[[maybe_unused]] const auto* original = s.base().data();
		[[maybe_unused]] auto replaced = std::move(s).replace_all(u8"z"_u8c, u8"yy"_utf8_sv);
		UTF8_RANGES_TEST_ASSERT(replaced == u8"abc"_utf8_sv);
		UTF8_RANGES_TEST_ASSERT(replaced.base().data() == original);
	}
	{
		auto s = u8"aaaa"_utf8_s;
	...
	}
	{
		auto s = u8"A\u00E9\U0001F600"_utf8_s;
		std::array<char8_t, 8> buffer{};
		if (!expect_out_of_range([&] { s.copy(buffer.data(), 1, decltype(s)::npos); }))
		{
			UTF8_RANGES_TEST_ASSERT(false);
		}
		if (!expect_out_of_range([&] { s.copy(buffer.data(), 1, 2); }))
		{
			UTF8_RANGES_TEST_ASSERT(false);
		}
		if (!expect_out_of_range([&] { s.copy(buffer.data(), 1, 1); }))
		{
			UTF8_RANGES_TEST_ASSERT(false);
		}
	}
	{
		auto s = u8"A\u00E9\U0001F600"_utf8_sv;
		std::array<char8_t, 8> buffer{};
		if (!expect_out_of_range([&] { s.copy(buffer.data(), 1, decltype(s)::npos); }))
		{
			UTF8_RANGES_TEST_ASSERT(false);
	...
	}
	{
		...
		if (!expect_out_of_range([&] { s.copy(buffer.data(), 1, 3); }))
		{
			UTF8_RANGES_TEST_ASSERT(false);
		}
		if (!expect_out_of_range([&] { s.copy(buffer.data(), 1, 2); }))
	...
	{
		auto s = u"A\u00E9\U0001F600"_utf16_sv;
		std::array<char16_t, 4> buffer{};
		if (!expect_out_of_range([&] { s.copy(buffer.data(), 1, decltype(s)::npos); }))
		{
			UTF8_RANGES_TEST_ASSERT(false);
	...
	{
		auto s = U"A\u00E9\U0001F600"_utf32_sv;
		std::array<char32_t, 3> buffer{};
		if (!expect_out_of_range([&] { s.copy(buffer.data(), 1, decltype(s)::npos); }))
		{
			UTF8_RANGES_TEST_ASSERT(false);
	...
	{
		utf8_string s{ utf8_text };
		if (!expect_out_of_range([&] { s = std::move(s).replace_at(decltype(s)::npos, 1, "Ω"_utf8_sv); }))
		{
			UTF8_RANGES_TEST_ASSERT(false);
		}
	}
	{
		utf8_string s{ utf8_text };
		if (!expect_out_of_range([&] { s = std::move(s).replace_at(2, 1, "Ω"_utf8_sv); }))
		{
			UTF8_RANGES_TEST_ASSERT(false);
		}
	}
	{
		utf8_string s{ utf8_text };
		if (!expect_out_of_range([&] { s = std::move(s).replace_at(1, 1, "Ω"_utf8_sv); }))
		{
			UTF8_RANGES_TEST_ASSERT(false);
		}
	}
	{
		utf8_string s{ utf8_text };
		if (!expect_out_of_range([&] { s = std::move(s).replace_at(s.size(), "Ω"_utf8_sv); }))
		{
			UTF8_RANGES_TEST_ASSERT(false);
		}
	}
	{
		utf8_string s{ utf8_text };
		if (!expect_out_of_range([&] { s = std::move(s).replace_at(2, "Ω"_u8c); }))
		{
			UTF8_RANGES_TEST_ASSERT(false);
		}
	}
	{
		utf8_string s{ utf8_text };
		if (!expect_out_of_range([&] { s = std::move(s).replace_at(decltype(s)::npos, 1, std::array{ "Ω"_u8c }); }))
		{
			UTF8_RANGES_TEST_ASSERT(false);
		}
	}
	{
		utf8_string s{ utf8_text };
		if (!expect_out_of_range([&] { s = std::move(s).replace_at(2, std::array{ "Ω"_u8c }); }))
		{
			UTF8_RANGES_TEST_ASSERT(false);
		}
	}
