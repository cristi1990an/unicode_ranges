...
fn emit_case_mapping_support(max_length: usize) {
    ...
    println!("        else");
    println!("        {{");
    println!("            return mappings.data() + mid;");
    println!("        }}");
    println!("    }}");
...
fn emit_bmp_case_mapping_table(name: &str, _mappings: &[CaseMappingRecord]) {
    ...
    println!("    }}");
    println!();
    println!("    const auto simple_index = find_source_mapping_index(scalar, {simple_mappings_name});");
    println!("    if (simple_index != {simple_mappings_name}.size())");
    println!("    {{");
    println!("        const auto& mapping = {simple_mappings_name}[simple_index];");
    ...
    println!("    }}");
    println!();
    println!("    if (find_source_mapping_index(scalar, {special_mappings_name}) != {special_mappings_name}.size())");
    println!("    {{");
    println!("        return unicode_bmp_case_mapping{{ static_cast<char16_t>(scalar), false }};");
    println!("    }}");
    println!();
